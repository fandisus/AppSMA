...
Public Class ListPenjurusan
    ...
    Private Sub LoadRecord()
        ...
        TextBoxBahasaIndonesia.Text = mpenjurusan.BahasaIndonesia
        TextBoxBahasaInggris.Text = mpenjurusan.BahasaInggris
        TextBoxMatematika.Text = mpenjurusan.Matematika
        TextBoxFisika.Text = mpenjurusan.Fisika
        TextBoxKimia.Text = mpenjurusan.Kimia
        TextBoxBiologi.Text = mpenjurusan.Biologi
        TextBoxEkonomi.Text = mpenjurusan.Ekonomi
        TextBoxGeografi.Text = mpenjurusan.Geografi
        TextBoxSosiologi.Text = mpenjurusan.Sosiologi
